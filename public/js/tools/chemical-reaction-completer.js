document.getElementById("generate-button").addEventListener("click", async () => {
    ...
    if (!content) {
        resultArea.textContent = "Please provide some reactants to complete reaction.";
        return;
    }
    ...
    try {
        ...
        const response = await fetch("https://tools-api-alpha.vercel.app/api/chemical/reaction-completer", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
            },
            body: JSON.stringify({ reactants: content })
        });
